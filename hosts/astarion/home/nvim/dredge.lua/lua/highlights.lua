...
function M.setup(colors, overrides)
  ...
  local highlights = {
    ...
    BufferLineModifiedSelected    = { fg = c.base09, bg = c.base00 },
    BufferLineModifiedVisible     = { fg = c.base09, bg = c.base01 },
    BufferLineSeparator           = { fg = c.base01, bg = c.base01 },
    BufferLineSeparatorSelected   = { fg = c.base00, bg = c.base00 },
    BufferLineSeparatorVisible    = { fg = c.base01, bg = c.base01 },
    BufferLineTab                 = { fg = c.base03, bg = c.base01 },
    BufferLineTabSelected         = { fg = c.base05, bg = c.base00 },
    ...
    BufferLineCloseButtonVisible  = { fg = c.base03, bg = c.base01 },
    BufferLineDuplicate           = { fg = c.base03, bg = c.base01 },
    BufferLineDuplicateSelected   = { fg = c.base05, bg = c.base00 },
