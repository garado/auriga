...
function M.setup(colors, overrides)
  ...
  local highlights = {
    ...
    -- blink-cmp
    BlinkCmpMenu             = { fg = c.base05, bg = c.base01 },
    BlinkCmpMenuBorder       = { fg = c.base03, bg = c.base01 },
    BlinkCmpMenuSelection    = { fg = c.base00, bg = c.base0D },
    BlinkCmpLabel            = { fg = c.base05 },
    BlinkCmpLabelDeprecated  = { fg = c.base03, strikethrough = true },
    BlinkCmpLabelMatch       = { fg = c.base0D, bold = true },
    BlinkCmpKind             = { fg = c.base0E },
    BlinkCmpKindText         = { fg = c.base05 },
    BlinkCmpKindMethod       = { fg = c.base0D },
    BlinkCmpKindFunction     = { fg = c.base0D },
    BlinkCmpKindConstructor  = { fg = c.base0A },
    BlinkCmpKindField        = { fg = c.base08 },
    BlinkCmpKindVariable     = { fg = c.base08 },
    BlinkCmpKindClass        = { fg = c.base0A },
    BlinkCmpKindInterface    = { fg = c.base0A },
    BlinkCmpKindModule       = { fg = c.base0E },
    BlinkCmpKindProperty     = { fg = c.base08 },
    BlinkCmpKindKeyword      = { fg = c.base0E },
    BlinkCmpKindSnippet      = { fg = c.base0B },
