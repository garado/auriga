...
import { App, Astal, Gtk, Gdk, Widget, astalify, hook } from 'astal/gtk4'
...
const ContribBox = (intensity = 0) => DrawingArea({
...
const ContribGrid = () => Grid({
  ...
  setup: self => hook(self, contribData, self => {
    print(JSON.stringify(contribData))
...
export const Github = () => Widget.Box({
